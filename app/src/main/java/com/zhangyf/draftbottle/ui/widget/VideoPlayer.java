package com.zhangyf.draftbottle.ui.widget;
...
//   我将此段代码添加在else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH){} 中
    ...
    private void load() {
        ...
        try {
            ...
            if (Objects.equals(mUri.getScheme(), ContentResolver.SCHEME_ANDROID_RESOURCE)) {
                RawDataSourceProvider rawDataSourceProvider = RawDataSourceProvider.create(mContext, mUri);
